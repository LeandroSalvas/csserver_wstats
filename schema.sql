...
CREATE TABLE `csstats` (
  ...
  `server_name` varchar(32) NOT NULL DEFAULT 'main',
  PRIMARY KEY (`id`),
  UNIQUE KEY `server_steamid` (`server_name`, `steamid`(16)),
...
CREATE TABLE `csstats_snapshots` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_snap_steamid_time` (`steamid`, `created_at`),
  KEY `idx_snap_map` (`map`),
  KEY `idx_snap_created` (`created_at`),
  KEY `idx_snap_server` (`server_name`)
) ENGINE=InnoDB AUTO_INCREMENT=10612 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

-- Nota: para bancos existentes, aplicar manualmente:
