...
setVisibleSlots(const playerId = 0)
{
	...
	{
		// Plugin inativo (sem reserva/hide de slots): nao toca no
		// sv_visiblemaxplayers. Resetar para MaxClients vira -1 no
		// resetVisibleSlots, sobrescrevendo o valor do server.cfg
		// (design de slot oculto para o HLTV).
		return;
	}
