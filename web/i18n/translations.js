const i18n = {
  pt: {
    ...
    labels: {
      ...
      watchLive: 'Acompanhe o placar ao vivo',
      rounds: 'Rounds',
      roundsT: 'Rounds T',
      roundsCT: 'Rounds CT',
      winrate: 'Winrate',
    ...
    serverManager: {
      ...
      addCstvHint: 'Indisponível para Zombies',
      addMode: 'Modo de jogo',
      mode: 'Modo',
      ...
      actionStart: 'Iniciando servidor...',
      actionStop: 'Parando servidor...',
      actionRestart: 'Reiniciando servidor...',
      actionRemove: 'Removendo servidor...',
      provisioning: 'Provisionando...',
      actionWait: 'Aguarde, processando...'
    },
    adminUsers: {
    ...
    server: {
      ...
      addressDesc: 'Conecte-se ao nosso servidor principal. Temos diversos servidores disponíveis com diferentes modos de jogo.',
    ...
    cmd: {
      ...
      botAdd: 'Adiciona 1 bot ao servidor',
      botKick: 'Remove o bot especificado',
      botKickAll: 'Remove todos os bots',
      botStop: 'Congela os bots (debug)',
      botDifficulty: 'Define dificuldade (0=Fácil, 1=Normal, 2=Difícil, 3=Expert)',
      botChatter: 'Define o modo de voz (off/minimal/radio/normal)',
      botQuota: 'Define a cota de bots (0-32)',
      botQuotaMode: 'Define o modo da cota (fill=preenche, normal=fixo)',
  ...
  en: {
    ...
    labels: {
      ...
      watchLive: 'Follow the live score',
      rounds: 'Rounds',
      roundsT: 'Rounds T',
      roundsCT: 'Rounds CT',
      winrate: 'Winrate',
    ...
    serverManager: {
      ...
      addCstvHint: 'Not available for Zombies mode',
      addMode: 'Game mode',
      mode: 'Mode',
      modeStandard: 'Standard',
      modeZombies: 'Zombies',
      ...
      actionStart: 'Starting server...',
      actionStop: 'Stopping server...',
      actionRestart: 'Restarting server...',
      actionRemove: 'Removing server...',
      provisioning: 'Provisioning...',
      actionWait: 'Please wait, processing...'
    },
    adminUsers: {
    ...
    server: {
      ...
      addressDesc: 'Connect to our main server. We have several servers available with different game modes.',
    ...
    cmd: {
      ...
      botAdd: 'Adds 1 bot to the server',
      botKick: 'Removes specified bot',
      botKickAll: 'Removes all bots',
      botStop: 'Freezes bots (debug)',
      botDifficulty: 'Sets difficulty (0=Easy, 1=Normal, 2=Hard, 3=Expert)',
      botChatter: 'Sets voice mode (off/minimal/radio/normal)',
      botQuota: 'Sets bot quota (0-32)',
      botQuotaMode: 'Sets quota mode (fill=dynamic, normal=fixed)',
