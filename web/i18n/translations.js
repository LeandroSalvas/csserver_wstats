const i18n = {
  pt: {
    ...
    serverManager: {
      ...
      actionRestarting: 'Ação disparada — a API reinicia para aplicar a mudança; recarregando...',
      addOk: 'Servidor adicionado! O provisionamento roda em segundo plano (leve ~1-2 min).',
      addError: 'Erro ao adicionar o servidor.',
      addProvisioning: 'Servidor sendo provisionado (a API reinicia no meio) — recarregando...',
  ...
  en: {
    ...
    serverManager: {
      ...
      actionRestarting: 'Action fired — the API restarts to apply the change; reloading...',
      addOk: 'Server added! Provisioning runs in the background (takes ~1-2 min).',
      addError: 'Error adding the server.',
      addProvisioning: 'Server being provisioned (the API restarts midway) — reloading...',
